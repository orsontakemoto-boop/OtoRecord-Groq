    ...
    try {
      ...
      reader.onloadend = async () => {
        try {
          ...
          // Se for erro de autenticação (401), limpa a chave
          if (innerError.message && innerError.message.includes("401")) {
            safeRemoveItem('otoRecordGroqKey');
            setApiKey('');
            setErrorMsg("Chave de API inválida ou expirada (401). Configure novamente.");
          } else {
            // Outros erros (400, 500, etc) apenas mostram mensagem
